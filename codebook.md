...
df2 is an extracted version of df1 that includes only those variables with 'mean' or 'std' in the df1 variable names. It has additionally been transformed by grouping by activity and subject and finding the mean for each variable for each combination of the two grouped variables.

#df1

df1 is a merged version of the seven upper-level data files unzipped from the file downloaded from: http://archive.ics.uci.edu/ml/machine-learning-databases/00240/UCI%20HAR%20Dataset.zip 
...
The blow informaton is taken from the UCI website:
